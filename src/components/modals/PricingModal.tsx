          ...
          <div className='p-4 space-y-3'>
            ...
            <div className='text-center mt-4'>
              ...
              <div className='flex justify-center space-x-2 flex-wrap'>
                ...
                <div className='w-8 h-5 bg-red-600 rounded text-xs flex items-center justify-center text-white'>
                  MC
                </div>
                <div className='w-8 h-5 bg-blue-700 rounded text-xs flex items-center justify-center text-white'>
                  AE
                </div>
                <div className='w-8 h-5 bg-orange-600 rounded text-xs flex items-center justify-center text-white'>
                  D
                </div>
                <div className='w-8 h-5 bg-green-600 rounded text-xs flex items-center justify-center text-white'>
                  JCB
                </div>
              </div>
            </div>
          ...
          <div className='flex-1 p-4 sm:p-6 lg:p-8'>
            ...
            <div className='space-y-4'>
              ...
              {features.map((feature, index) => (
                <div
                  key={index}
                  className='grid grid-cols-1 sm:grid-cols-3 gap-4 items-center py-3 border-b border-[#333]'
                >
                  <div>
                  ...
                  <div className='text-center hidden sm:block'>
                    {feature.free ? (
                      ...
                      <div className='w-4 h-4 bg-gray-600 rounded-full mx-auto' />
                    )}
                  </div>
                  <div className='text-center hidden sm:block'>
                    <Check size={16} className='text-green-500 mx-auto' />
