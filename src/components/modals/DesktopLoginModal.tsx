        ...
        <div className="flex min-h-[600px]">
          ...
          <div className="flex-1 bg-muted/30 p-8 flex flex-col justify-center">
            <div className="text-center mb-8">
              ...
              <div className="text-lg font-semibold text-foreground mb-2">AI Assistant</div>
              ...
              <div className="text-3xl font-bold text-foreground mb-2">30M+ users</div>
          ...
          <div className="w-96 p-8 flex flex-col justify-center relative">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold mb-2 text-foreground">Join Millions of Happy Users</h2>
