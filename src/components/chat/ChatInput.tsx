    ...
    return (
      ...
      >
        ...
        <Input
          ...
          disabled={disabled}
          className='flex-1 bg-transparent border-0 text-white placeholder-gray-500 focus:ring-0 focus:outline-none focus-visible:border-0 focus-visible:ring-0 disabled:opacity-50 disabled:cursor-not-allowed'
        />
        <Button
          size='sm'
