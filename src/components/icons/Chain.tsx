...
interface ChainProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

export const Chain = ({ size = 16, className = '', ...props }: ChainProps) => (
  <svg
    width={size}
    height={size}
    viewBox='0 0 29 29'
